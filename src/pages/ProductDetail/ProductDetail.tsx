...
function ProductDetail({ idproductinfo }: ProductDetailProps) {
        ...
        <div className="row d-flex gap-5">
          <div className="col-lg-5 col-sm-12">
            <div className="position-relative">
              <Carousel
                imgUrls={[
                  "https://image.uniqlo.com/UQ/ST3/vn/imagesgoods/457758/item/vngoods_00_457758.jpg?width=750",
                  "https://image.uniqlo.com/UQ/ST3/vn/imagesgoods/457758/sub/vngoods_457758_sub7.jpg?width=750",
                  "https://image.uniqlo.com/UQ/ST3/vn/imagesgoods/457758/sub/vngoods_457758_sub9.jpg?width=750",
                ]}
              />
            </div>
            <div className=" mt-5">
          ...
          >
            ...
            <hr />
            <div>
              <SelectBox idproductinfo={idproductinfo!} />
            </div>
          </div>
        </div>
        <div
